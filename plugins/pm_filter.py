...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/allnewmovieintime")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='Source code is not available, because this is private bot')
            ],[
